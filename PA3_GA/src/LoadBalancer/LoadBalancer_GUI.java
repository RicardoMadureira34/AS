...
public class LoadBalancer_GUI extends javax.swing.JFrame {
    ...
    private void StartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartButtonActionPerformed
        try {
            ...
            System.out.println("Monitor esta vivo");
            ServerSocket ss_forServer=new ServerSocket(port_forserver);
            Socket s_forServer = ss_forServer.accept();
            
            while(true){
                try {
                    ServerSocket ss_forclient=new ServerSocket(port_forclient);
                    System.out.println("Client: " + counter + " esta vivo");
                    Socket s_forclient=ss_forclient.accept();
                    
                    ThreadLoadBalancer t= new ThreadLoadBalancer(s_forclient,s_formonitor, s_forServer ,counter);
                    t.start();
                    counter++;
