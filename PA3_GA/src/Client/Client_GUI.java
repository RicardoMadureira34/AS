...
public class Client_GUI extends javax.swing.JFrame {
    ...
    private void StartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartButtonActionPerformed
       ...
       ThreadClient client = new ThreadClient(socketConnection);
       //client.start();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here: 
        ThreadRequestClient req = new ThreadRequestClient(socketConnection, mostrarrequestpensentes, ni_Swing);
        req.start();
