...
public class ThreadLB_Request extends Thread {
    ...
    public ThreadLB_Request(String request_cliente, HashMap<Integer, Socket> server_connect,
            Socket serverSocketMonitor, HashMap<Integer, Socket> clientes_connect,
            HashMap<Integer, ArrayList> req_cadaservidor, int ser_crash) {
