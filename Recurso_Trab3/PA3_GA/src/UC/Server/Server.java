            ...
            public Boolean doInBackground() throws Exception {
                ...
                cont_req_recebidos_swing.setText(String.valueOf(requeste_iniciais.size()));
                    ...
                    if (controlar_request.size() < 3) {
                        ...
                        ServerRequest serverRequest = new ServerRequest(requestInfo, portId_server,
                        controlar_request, contar_request, enviar_LB,
                        0, id, requeste_executado_swing, request_executados, cont_reqexecutados_swing);
